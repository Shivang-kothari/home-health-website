...
export default async function EmployeeDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      ...
      <h1 className="mt-3 text-[color:var(--heading)]">Employee #{id}</h1>
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-2">
        <Card className="p-5">
          <div className="text-sm font-semibold text-[color:var(--heading)]">Credentials</div>
        ...
        <Card className="p-5">
          <div className="text-sm font-semibold text-[color:var(--heading)]">Documents</div>
