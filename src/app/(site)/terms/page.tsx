    ...
    <section className="py-14">
      <Container>
        <div className="mx-auto max-w-3xl">
          <h1 className="text-slate-900">Terms of Service</h1>
          ...
          <div className="mt-10 grid gap-6 text-sm text-slate-700">
            <Reveal>
              <Card className="p-6">
                <div className="font-semibold text-slate-900">Use of the website</div>
            ...
            <Reveal delayMs={120}>
              <Card className="p-6">
                <div className="font-semibold text-slate-900">No warranties</div>
                <p className="mt-2 text-slate-600">
